...
#define DDS_SPI_SCLK_PIN          			GPIO_PIN_3
#define DDS_SPI_SCLK_GPIO_PORT    			GPIOB
...
#define DDS_SPI_SDIO_PIN          			GPIO_PIN_5
#define DDS_SPI_SDIO_GPIO_PORT    			GPIOB
...
#define DDS_SPI_SDO_PIN          			GPIO_PIN_4 // Serial Data Output.
#define DDS_SPI_SDO_GPIO_PORT    			GPIOB
...
#define DDS_SPI_CS_PIN          			GPIO_PIN_4 // chip Select. Active low.
...
#define DDS_IO_UPDATE_PIN       			GPIO_PIN_15
#define DDS_IO_UPDATE_GPIO_PORT 			GPIOF
...
#define DDS_IO_RESET_PIN           			GPIO_PIN_7
#define DDS_IO_RESET_GPIO_PORT     			GPIOC
...
#define DDS_MASTER_RESET_PIN           		GPIO_PIN_3
#define DDS_MASTER_RESET_GPIO_PORT     		GPIOD
...
#define DDS_PROFILE_0_PIN       			GPIO_PIN_2
#define DDS_PROFILE_0_GPIO_PORT 			GPIOB

#define DDS_PROFILE_1_PIN       			GPIO_PIN_8
#define DDS_PROFILE_1_GPIO_PORT 			GPIOE

#define DDS_PROFILE_2_PIN       			GPIO_PIN_13
#define DDS_PROFILE_2_GPIO_PORT 			GPIOD
...
#define DDS_OSK_PIN       					GPIO_PIN_4
#define DDS_OSK_GPIO_PORT 					GPIOF
...
#define DDS_PDCLK_PIN        				GPIO_PIN_3
#define DDS_PDCLK_GPIO_PORT  				GPIOE
...
#define DDS_TxENABLE_PIN        			GPIO_PIN_7
#define DDS_TxENABLE_GPIO_PORT  			GPIOE
...
#define DDS_F0_PIN        					GPIO_PIN_10
#define DDS_F0_GPIO_PORT  					GPIOE

/*Modulation Format Pins. Digital input to determine the modulation format*/
#define DDS_F1_PIN        					GPIO_PIN_12
#define DDS_F1_GPIO_PORT  					GPIOE

/* Parallel interface */
#define DDS_D0_PIN							GPIO_PIN_2
#define DDS_D0_GPIO_PORT					GPIOE

#define DDS_D1_PIN							GPIO_PIN_14
#define DDS_D1_GPIO_PORT					GPIOE

#define DDS_D2_PIN							GPIO_PIN_15
#define DDS_D2_GPIO_PORT					GPIOE

#define DDS_D3_PIN							GPIO_PIN_0
#define DDS_D3_GPIO_PORT					GPIOA

#define DDS_D4_PIN							GPIO_PIN_10
#define DDS_D4_GPIO_PORT					GPIOB

#define DDS_D5_PIN							GPIO_PIN_0
#define DDS_D5_GPIO_PORT					GPIOB

#define DDS_D6_PIN							GPIO_PIN_11
#define DDS_D6_GPIO_PORT					GPIOB

#define DDS_D7_PIN							GPIO_PIN_0
#define DDS_D7_GPIO_PORT					GPIOE

#define DDS_D8_PIN							GPIO_PIN_1
#define DDS_D8_GPIO_PORT					GPIOG

#define DDS_D9_PIN							GPIO_PIN_0
#define DDS_D9_GPIO_PORT					GPIOG

#define DDS_D10_PIN							GPIO_PIN_9
#define DDS_D10_GPIO_PORT					GPIOF

#define DDS_D11_PIN							GPIO_PIN_1
#define DDS_D11_GPIO_PORT					GPIOD

#define DDS_D12_PIN							GPIO_PIN_7
#define DDS_D12_GPIO_PORT					GPIOF

#define DDS_D13_PIN							GPIO_PIN_0
#define DDS_D13_GPIO_PORT					GPIOD

#define DDS_D14_PIN							GPIO_PIN_8
#define DDS_D14_GPIO_PORT					GPIOF

#define DDS_D15_PIN							GPIO_PIN_2
#define DDS_D15_GPIO_PORT					GPIOF

#define DDS_DRHOLD_PIN          			GPIO_PIN_11
#define DDS_DRHOLD_GPIO_PORT				GPIOE

#define DDS_PWR_DWN_PIN         			GPIO_PIN_4
#define DDS_PWR_DWN_GPIO_PORT   			GPIOE

#define DDS_DRCTL_PIN           			GPIO_PIN_14
#define DDS_DRCTL_GPIO_PORT     			GPIOF

#define DDS_DROVER_PIN          			GPIO_PIN_13
#define DDS_DROVER_GPIO_PORT    			GPIOE

#define DDS_SYNC_CLK_PIN        			GPIO_PIN_6
#define DDS_SYNC_CLK_GPIO_PORT  			GPIOB

#define DDS_RAM_SWP_OVR_PIN     			GPIO_PIN_6
#define DDS_RAM_SWP_OVR_GPIO_PORT 			GPIOE

#define DDS_PLL_LOCK_PIN        			GPIO_PIN_5
#define DDS_PLL_LOCK_GPIO_PORT  			GPIOE
...
#define Load_LRR_IO_update 					0x80
...
#define Sync_generator_polarity 			0x02
